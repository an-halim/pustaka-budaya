let contentList = [
    ...
    },
    {
        ...
        articles : [
            {
                articelPath: '/jateng/aksara-jawa',
                tittle: 'Aksara Jawa5125',
                articlePhoto: '/assets/img/gamelan.jpg'
            },
            {
                articelPath: '/jateng/aksara-jawa',
                tittle: 'Aksara Jawa52115',
                articlePhoto: '/assets/img/gamelan.jpg'
            },
            {
                articelPath: '/jateng/aksara-jawa',
                tittle: 'Aksara Jawa51125',
                articlePhoto: '/assets/img/gamelan.jpg'
            },
            {
                articelPath: '/jateng/aksara-jawa',
            ...
            {
                articelPath: '/jateng/aksara-jawa',
                tittle: 'Aksara Ja21wa',
                articlePhoto: '/assets/img/gamelan.jpg'
            },
            {
                articelPath: '/jateng/aksara-jawa',
                tittle: 'Aksara Ja51wa',
                articlePhoto: '/assets/img/gamelan.jpg'
            },
            {
                articelPath: '/jateng/aksara-jawa',
                tittle: 'Aksara Jaw1255a',
                articlePhoto: '/assets/img/gamelan.jpg'
            },
            {
                articelPath: '/jateng/aksara-jawa',
                tittle: 'Aksara Ja211wa',
                articlePhoto: '/assets/img/gamelan.jpg'
            },
            {
                articelPath: '/jateng/aksara-jawa',
...
const getRecomendation = (count) => {
    ...
    for(let i = 0; i < count; i++){
        ...
        do{
            ...
            randomArticle = Math.floor(Math.random() * contentList[randomAuthor].articles.length)
        ...
        }while(JSON.stringify(randomizeContents).includes(randomizeContent.article.tittle) && JSON.stringify(randomizeContents).includes(randomizeContent.name))
...
for(let i = 0; i < recomentationsEL.length; i++){
    ...
    authorName.innerHTML = data[i].name.length > 10 ? data[i].name.slice(0, 10).trimEnd() + '...' : data[i].name
    authorPhoto.src =parentUrl + data[i].photo
    articleProv.innerHTML = data[i].province.length > 6 ? data[i].province.slice(0, 6).trimEnd() + '...' : data[i].province
    article.innerHTML = data[i].article.tittle.length > 11 ? data[i].article.tittle.slice(0, 11).trimEnd().toUpperCase() + '...' : data[i].article.tittle.toUpperCase()
    articlePhoto.src = parentUrl + data[i].article.articlePhoto

    recomentationsEL[i].setAttribute('onclick', `window.location.href = '${parentUrl+data[i].article.articelPath}'`);
    console.log(data[i])
}